...
class HPEnvGeneral(gym.Env):
    def __init__(self, seq, maximal):
        self.seq = seq.upper()
        self.seq_len = len(self.seq)
        self.actions = []
        self.maximal_reward = maximal
    ...
    def _compute_reward(self) -> float:
        ...
        normlized_reward = total_reward / self.maximal_reward
    ...
    def reset(self, seed = None, options = None):
        ...
        if options is not None:
            new_seq = options.get("new_seq")
            maximal = options.get("maximal")
